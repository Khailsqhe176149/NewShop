...
public class UserProfileController extends HttpServlet {
    ...
    throws ServletException, IOException {
        ...
        User user = userDAO.getAccountByEmail(mail);               
        ...
        request.getRequestDispatcher("view/uprofile.jsp").forward(request, response);        
    } 
    ...
    throws ServletException, IOException {
        try {
            ...
            userDAO.UpdateUser(user.getUserID(), fullname, address, mobile);
            
//             Gửi phản hồi cho người dùng
            request.setAttribute("success", "Update DB Successfull");
            request.getRequestDispatcher("view/uprofile.jsp").forward(request, response);
        } catch (Exception e) {
            e.printStackTrace();            
            response.sendRedirect("view/uprofile.jsp?error=database_error");
