...
<!--        <h1>EDIT SLIDER ID : ${requestScope.sliderGetFromID.getSliderID()}</h1>
        <div>
            <form action="EditSlider?SliderID=${requestScope.sliderGetFromID.getSliderID()}" method="POST">
                <table border="1">
                    <thead>
                        <tr>
                            <th>Slide ID</th>
                    ...
                    <tbody>                       
                        <tr>                    
                            ...
                            <td>               
                                 Rounded switch 
                                <label class="switch">
                                    <input type="checkbox" name="SliderStatus" value="checked">
        ...
        <div class="container">
            ...
            <form action="EditSlider?SliderID=${requestScope.sliderGetFromID.getSliderID()}" method="POST" class="form">
                <table class="table">
                    <thead>
                        <tr>
                            <th>Slide ID</th>
